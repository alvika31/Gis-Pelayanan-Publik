  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="<?=site_url('front')?>">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              ...
              <li class="nav-item"> <a class="nav-link" href="<?=base_url('page/v_home')?>">List Maps</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?=base_url('page/data_landmark')?>">List Marker</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?=base_url('page/data_landmark_polygon')?>">List Polygon</a></li>
                
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?=base_url('map/readKategori')?>">
              <i class="menu-icon mdi mdi-home-map-marker"></i>
              <span class="menu-title">Kategory Maps</span>
            </a>
          </li>
          <li class="nav-item">
