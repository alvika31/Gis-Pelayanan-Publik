    ...
    <div id="sidebar-left">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-5">
              <a href="<?=base_url('Front')?>" class="btn btn-success btn-sm" style="color: white; font-size: 13px;">Kembali Ke Beranda</a>
            </div>
          </div>
  ...
  $.getJSON("<?=base_url()?>index.php/mappolygon/getPolygon", function(result){
    $.each(result, function(i, field){
      var coordinates =  JSON.parse(result[i].coordinates)
          ...
          var customPopup   = "<center><h5><b>Kecamatan Informasi</b></h5></center>"+"<img src='<?=base_url()?>assets/uploads/"+result[i].photo+"' alt='map photo' width='300px'/>"+"<br><b><a href='<?=base_url('Front/filterMap_filtered/');?>"+result[i].id_polygon+"'><p style='weight: 700; font-size: 20px; font-family: poppins'>Name:"+result[i].name_polygon+"</p></a></b>"+"<h7>Detail :"+result[i].information+" </h7><br/>";
